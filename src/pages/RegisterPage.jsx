...
const novaLogo = '/assets/logo.svg';

// ✅ RegisterPage — extracted from my-university-app/src/App.js
        ...
        <div style={dynamicStyles.leftColumn}>
          <div style={dynamicStyles.heroSection}>
            <div style={dynamicStyles.heroLogoBox}>
              <img src="/assets/logo.png" alt="Nova Logo" style={dynamicStyles.heroLogo} />
            </div>
...
// ✅ Export alias so index.js can import as RegisterPage
export { NovaPerfect as RegisterPage };
